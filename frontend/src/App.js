...
const Appointments = () => {
  return (
    <div className="space-y-4 lg:space-y-6">
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        <h1 className="text-2xl lg:text-3xl font-bold tracking-tight text-slate-900">Citas</h1>
        <Button>
          <Plus className="w-4 h-4 mr-2" />
      ...
      >
        ...
        <CardHeader className="relative z-10 text-white">
          <CardTitle className="text-xl lg:text-2xl">Sistema de Citas Inteligente</CardTitle>
          <CardDescription className="text-slate-300">
            Gestiona tu agenda, envía recordatorios automáticos y mejora la puntualidad de tus pacientes.
          </CardDescription>
        </CardHeader>
      </Card>
